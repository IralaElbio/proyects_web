...
import lobbyUML from "../Assets/LobbyUML.png";

const challengesAndSolutions = [
  {
    title: "Managing Multiple Simultaneous Connections",
    challenge:
      "Accepting and handling multiple clients without blocking server operations.",
    solution:
      "A dedicated thread (ClientManager) was assigned to each client, allowing simultaneous request handling and efficient, isolated communication.",
  },
  {
    title: "Synchronization Between Clients and Lobbies",
    challenge:
      "Preventing conflicts when multiple clients interact with shared resources (lobbies)",
    solution:
      "GameManager acts as a monitor, synchronizing access to lobbies and ensuring no race conditions or inconsistencies occur.",
  },
  {
    title: "Transition from Lobby to Game",
    challenge:
      "Determining when a lobby is ready to start a game instance and managing a seamless transition.",
    solution:
      "Each Lobby notifies GameManager when all clients are ready, triggering the creation of a game instance and the removal of the lobby.",
  },
  {
    title: "Resource Usage Optimization",
    challenge:
      "Managing thread and resource creation/deletion to prevent server overload.",
    solution:
      "ClientManager threads, along with lobby and game instances, are properly disposed of once they have fulfilled their purpose (when clients leave the lobby to join the game).",
  },
];
...
const Lobby = () => {
  return <AccordionWNode items={content} titleVariant="h5" />;
};
