...
import shootingStrategy from "../Assets/ShootingStrategy.png";
import bulletType from "../Assets/BulletType.jpeg";
import weaponInterface from "../Assets/WeaponInterface.png";

const challengesAndSolutions = [
  {
    title: "Modular and Extensible Weapon Design",
    challenge:
      "Create a system that allows for easy addition of new weapon types and shooting strategies without affecting existing functionality.",
    solution:
      "The IActionableItem interface is implemented and the Strategy pattern (ShootingStrategy) is used to encapsulate specific shooting behaviors. This allows the integration of new weapon types without modifying existing classes.",
  },
  {
    title: "Management of Unique Bullet Behaviors",
    challenge:
      "Ensure that each bullet type (normal, explosive, bouncy, and special) has unique properties and effects while maintaining organized code.",
    solution:
      "A class hierarchy for bullets is defined, with a base Bullet class and specific subclasses that encapsulate unique behaviors. This simplifies code management and reuse.",
  },
  {
    title: "Centralized Weapon Creation",
    challenge:
      "Avoid logic duplication when creating weapons with specific characteristics.",
    solution:
      "The WeaponFactory class was designed to be responsible for constructing weapons and assigning the corresponding shooting strategy. This centralizes the logic and makes it easier to create new weapons.",
  },
  {
    title: "Simulation of Sustained Actions (Continuous Shooting)",
    challenge:
      "Manage the weapon state to support actions like automatic, semi-automatic or sustained shooting.",
    solution:
      "A continuous update method was implemented in IActionableItem, which evaluates the weapon’s state and adjusts its behavior dynamically based on its type.",
  },
];
...
const content = [
  ...
  },
  {
    ...
    content: (
      <Stack>
        <ItemList
          title="There are four types of bullets:"
          items={bulletTypes}
          titleVariant="h6"
        />
    ...
    <>
      <StyledBox>
        ...
        <FlexBoxRow>
          ...
          <FlexBoxRowContent>
            <DescriptionWithImage description="" imageSrc={weaponInterface} />
          </FlexBoxRowContent>
        </FlexBoxRow>
      </StyledBox>
