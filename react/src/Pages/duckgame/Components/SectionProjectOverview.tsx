  ...
  return (
    <StyledStackContainer>
      <FlexBoxRow marginBottom={6}>
        <FlexBoxRowContent>
          <SubSectionTitle>Project Overview</SubSectionTitle>
          <TextBody>
            Developed the server-side infrastructure for a real-time multiplayer
            action game, a replica of Duck Game, implementing client-server
            communication from scratch using C++ and sockets. Designed a
            multithreaded system to manage player connections, synchronize game
            state, and handle data transmission efficiently, ensuring all
        ...
        <ProjectOverviewVideo>
          <iframe
            width="100%"
            height="100%"
            src="https://www.youtube.com/embed/cPuMURXMKg0"
